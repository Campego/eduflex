...
export const Quiz = ({
  ...
  const [showReading, setShowReading] = useState(!!reading);
      ...
      <>
        ...
        <div className="flex h-full items-center justify-center">
          <div className="flex w-full flex-col gap-y-12 px-6 lg:min-h-[350px] lg:w-[600px] lg:px-0">
            ...
            <p className="whitespace-pre-line text-base text-gray-700 lg:text-lg">
              {reading.content}
            </p>
          </div>
        </div>
  ...
  return (
    <>
          ...
          <div className="flex w-full flex-col gap-y-12 px-6 lg:min-h-[350px] lg:w-[600px] lg:px-0">
            ...
            <div>
              ...
              <Challenge
                ...
                onWrittenChange={setWrittenAnswer}
                onSubmitWritten={onContinue}
              />
            </div>
          </div>
        </div>
      ...
      <Footer
        disabled={
          pending ||
          (challenge.type === "SELECT" && !selectedOption) ||
          (challenge.type === "WRITE" && !writtenAnswer.trim())
        }
        status={status}
        onCheck={onContinue}
      />
