    ...
    <main className="bg-white">
      ...
      <section className="bg-orange-50 py-20 px-6">
        <div className="mx-auto max-w-5xl text-center">
          <h2 className="text-3xl font-bold text-orange-500 mb-4">¡Empieza gratis hoy!</h2>
          <p className="text-gray-700 text-lg mb-8">
            Regístrate ahora y accede al primer curso de práctica sin costo. ¡Da el primer paso hacia una nueva forma de aprender programación!
          </p>
          <div className="flex justify-center mb-8">
            <Image src="/practice-preview.png" alt="Vista previa del curso" width={600} height={350} className="rounded-xl shadow-lg" />
          </div>
      ...
      <section id="about" className="bg-white py-20 px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex justify-center">
            <Image src="/mission.jpg" alt="Nuestra misión" width={500} height={300} className="rounded-lg shadow-md" />
          </div>
        </div>
      </section>
      ...
      <footer className="bg-white border-t py-10 px-6 text-center text-sm text-gray-500">
